...
public class App {
  ...
  public static void main(String[] args) {
    ...
    menu = new Menu(1, "Fried rice.", 45.00, "อาหาร", "On", promotion);
  ...
  public static void displayCustomer() {
    ...
    displayMessageLine("(2) Booking information.");
    displayMessageLine("(3) Order food.");
    displayMessageLine("(4) The ordered food items.");
  ...
  public static void displayEmployeeMenuOnOff() {
    ...
    displayMessageLine("Hi : " + employee.Get_person_id());
    displayMessageLine("Please select a number.");
    displayMessageLine("(1) Edit the food status");
    displayMessageLine("(2) Edit the beverages status");
    displayMessageLine("(0) back");
    displayMessage("Your input : ");
    yourInput = inputInt();
  ...
  public static void displayEmployeeReceipt() {
    ...
    if(yourInput == receipt.Get_Transaction_id()){
      ...
      int randomNumber = ThreadLocalRandom.current().nextInt(1000, 10000);
      displayMessageLine("Invoice Number : "+ randomNumber);
      displayMessageLine("Table Number : "+ receipt.Get_Transaction_table_id());
      displayMessageLine("Invoice Date : " + LocalDate.now());
      displayMessageLine("Invoice Time : " + LocalTime.now());
      displayMessageLine("Menu Item Name : "+ receipt.Get_transaction_menu_name() + "Quantity x" + receipt.Get_transaction_menu_amount() + "Price" + receipt.Get_transaction_total_price() +  "baht");
      displayMessageLine("Note to the Restaurant : " + receipt.Get_note());
      displayMessageLine("VAT 7% : " + " baht" + receipt.Get_receipt_vat()*receipt.Get_transaction_total_price() );
      displayMessageLine("Total Amount to Pay : " + " baht" + receipt.Get_receipt_change());
